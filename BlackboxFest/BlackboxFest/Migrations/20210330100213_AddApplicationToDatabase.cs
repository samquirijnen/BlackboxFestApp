        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ArtistShortDescription = table.Column<string>(nullable: true),
                    ArtistLongDescription = table.Column<string>(nullable: true),
                    MusicGenre = table.Column<string>(nullable: true),
                    BookingAgentId = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_News_UserNews_NewsId",
                        column: x => x.NewsId,
                        principalTable: "UserNews",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
